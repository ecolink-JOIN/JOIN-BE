...
public class ViewHistoryReadController {
    ...
    @GetMapping
    public List<ViewStudyReadResponse> getViewStudyByAvatarId(@AuthenticationPrincipal UserPrincipal principal) {
        return viewHistoryReadService.getViewStudyByAvatarId(principal.getAvatarId());
    }
}
