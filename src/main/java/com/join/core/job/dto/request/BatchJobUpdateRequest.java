...
public class BatchJobUpdateRequest {
    @Schema(description = "알림 내용", example = "내일은 스터디 모임일입니다. (생략 가능, 변경 시에만 입력)")
    @Size(min = 10, max = 100)
    private String content;

    @Schema(description = "요일", example = "MON (생략 가능, 변경 시에만 입력)")
    private DayType day;

    @Schema(description = "발송 시간", example = "18:30 (생략 가능, 변경 시에만 입력)")
