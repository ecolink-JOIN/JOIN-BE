...
import com.join.core.auth.dto.OAuth2StateResponse;
import com.join.core.auth.service.OAuth2RequestService;
...
public class OAuth2Controller {
	...
	@Operation(summary = "소셜 로그인 state 토큰 발급 API",
		description = "클라이언트를 확인하고 클라이언트 확인에 필요한 state 값을 반환해줍니다. [CSRF 공격 방지 목적]\n\n"
